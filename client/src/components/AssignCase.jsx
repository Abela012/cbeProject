...
const AssignCase = ( {caseId, handleClose}) => {
  ...
  return (
    <OverLay handleClick={handleClose} >
      <form onSubmit={handleSubmit}  className=" flex flex-col gap-4 bg-white p-5 rounded-lg w-[80%] sm:w-[400px] ">
      <select
        ...
        <Button className=" !bg-transparent !border-solid !border-2" onClick={()=> handleClose()} >Done</Button>
        </div>
       </form >
    </OverLay>
  )
